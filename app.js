...
app.post('/register', async (req,res)=>{
  ...
  connection.query('INSERT INTO registros SET ?',{nombre:nombre, email:email, contra:contra, repcontra:repcontra}, async(error, results)=>{
    if(error){
      console.log(error);
    }else{
      res.render('index',{
